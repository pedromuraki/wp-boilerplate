...
/*!***************************!*\
  !*** ./src/js/helpers.js ***!
  \***************************/
/*! exports provided: toggleClass, addClass, removeClass, nodelistToArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var toggleClass = function toggleClass(el, cl) {
  return !el.classList.contains(cl) ? el.classList.add(cl) : el.classList.remove(cl);
};

var addClass = function addClass(el, cl) {
  return el.classList.add(cl);
};

var removeClass = function removeClass(el, cl) {
